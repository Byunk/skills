...
| 3 | [Hierarchical Context Organization](references/03-hierarchical-organization.md) | `03-hierarchical-organization.md` | Structure context from general (system) to specific (task). |
| 4 | [Multi-Dimensional Context](references/04-multi-dimensional-context.md) | `04-multi-dimensional-context.md` | Effective context spans task, domain, history, constraints, and format. |
...
| 6 | [Invest in Tool Design (ACI)](references/06-invest-in-tool-design.md) | `06-invest-in-tool-design.md` | Tool descriptions deserve as much effort as UIs. Poka-yoke your tools. |
...
| 8 | [Transparency in Agent Planning](references/08-transparency-in-planning.md) | `08-transparency-in-planning.md` | Show the agent's planning steps explicitly. Don't hide reasoning. |
...
| 11 | [Meta-Context](references/11-meta-context.md) | `11-meta-context.md` | Explain why information is provided so models weight it appropriately. |
...
| 15 | [Avoid Common Anti-Patterns](references/15-anti-patterns.md) | `15-anti-patterns.md` | Don't dump everything, over-abstract, or ignore tool documentation quality. |
